...
\begin{table}[!htbp]
\centering
\caption{Selected baseline sanity checks, not a full benchmark suite. Random forest and Chemprop use sampled ChEMBL 36 splits for context; the current model and previous so\_f4 comparison use the full future prediction artifacts.}
\label{tab:baselines}
